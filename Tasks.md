...
- [ ] 訪問履歴 — 訪れた道の駅の記録
- [x] フォトアルバム — 道の駅・カントリーサインごと最大3枚の写真を保存・閲覧・削除 (iOS版準拠)
- [x] Google Drive バックアップ — お気に入り・踏破データ＋フォトアルバムの手動＆自動バックアップ/復元
...
- [x] 設定画面バージョン表記固定化 — ハードコードをやめ BuildConfig.VERSION_NAME から動的取得
...
- 2026-04-11: 踏破済みタブアイコン色修正, 道の駅リストにお気に入り/踏破アイコン追加, CSフォトアルバム追加, Google Driveバックアップ/復元 (手動+自動), CSバッジアイコン修正 (お気に入り+踏破=赤シールド)
- 2026-04-13: 設定画面のバージョン表記を BuildConfig.VERSION_NAME から動的取得するよう修正 (リリース毎の手動更新不要化)
- 2026-04-13: v2.0.3 (versionCode 5) リリース — 軽微な内部改善
